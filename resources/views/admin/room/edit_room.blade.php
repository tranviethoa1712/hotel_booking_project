                ...
                <div>
                    ...
                    <form action="{{url('update_room', $room->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="max_guest" value="{{ $room->max_guest }}">
                        </div>
                        <div class="form-group">
                            <label class="text-white">Number of room</label>
                            <input class="form-control" type="text" name="number_of_room" value="{{ $room->number_of_room }}">
